...
class MainFrame ( wx.Frame ):
	...
	def __init__( self, parent ):
		...
		self.richText_front.SetFont( wx.Font( wx.NORMAL_FONT.GetPointSize(), wx.FONTFAMILY_MODERN, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_BOLD, False, wx.EmptyString ) )
		...
		self.Bind( wx.EVT_MENU, self.on_menu_software, id = self.menuItem_software.GetId() )
	...
	def on_menu_software( self, event ):
		event.Skip()
